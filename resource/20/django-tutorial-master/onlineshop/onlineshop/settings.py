...
SECRET_KEY = 'django-insecure-0&mai2&ma%e*)nil@pva2kwg@v#_3r(%5r**b!_90r=5_a2u4w'
...
INSTALLED_APPS.append('debug_toolbar') if DEBUG else None

# 1. add something to request, request.user
# 2. check 
# 3. return response
# 4. pushe_version
...
MIDDLEWARE.insert(0, 'debug_toolbar.middleware.DebugToolbarMiddleware') if DEBUG else None
...
AUTH_USER_MODEL = 'core.User' # "app_name.Model"
